...
class HaarcascadesFiles:
    ...
    def get(value):
        ...
        files = {
            f.split(".")[0]: os.path.join(cv_data.haarcascades, f)
            for f in os.listdir(cv_data.haarcascades)
        }
